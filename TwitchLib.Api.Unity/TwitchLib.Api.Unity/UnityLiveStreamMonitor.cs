...
namespace TwitchLib.Unity
{
    public class UnityLiveStreamMonitor : LiveStreamMonitorService
    {
        ...
        public UnityLiveStreamMonitor(ITwitchAPI api, int checkIntervalSeconds = 60, int checkIntervalInSeconds = 60, int maxStreamRequestCountPerRequest = 100) : base(api, checkIntervalSeconds, maxStreamRequestCountPerRequest)
        {
